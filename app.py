...
nav= dbc.Nav(
                    [
                        dbc.DropdownMenu(
                            ...
                            nav=True,
                            in_navbar=True,
                            label=dbc.NavLink("INTRODUCCIÓN", href="/",style={'padding':0,'marginLeft':'0rem'}),
                        ),
                        dbc.DropdownMenu(
                            [
                        ...
                        dbc.DropdownMenu(
                            ...
                            nav=True,
                            in_navbar=True,
                            label=dbc.NavLink("BIBLIOGRAFÍA", href="/khoka_bibliography",style={'padding':0,'marginRight':'0rem'}),    
                        ),
                    ],
